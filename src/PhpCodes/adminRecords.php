    ...
    <div class="flex text-[#527920] relative">   
        <nav class="bg-[#81A94E] z-20 fixed hidden duration-150 h-full lg:block shrink-0 w-[18rem] lg:h-[100vh] ">
            ...
            <div class="w-full text-white flex tracking-wider flex-col justify-center items-center">
                ...
                <a href="../Admin/units.php" class="py-4 hover:bg-[#6a8349] duration-150 cursor-pointer flex items-center self-start w-full pl-4">
                ...
                <a href="../Admin/payment.php" class="py-4 bg-[#54683A] duration-150 cursor-pointer flex items-center self-start w-full pl-4">
        ...
        <nav id="navlink" class="bg-[#81A94E] flex left-[-65rem] z-20 lg:hidden duration-500 top-0 h-full fixed shrink-0 w-full">
            ...
            <div class="w-full text-white flex tracking-wider mt-5 flex-col items-center">
                ...
                <a href="../Admin/units.php" class="py-4 my-2 justify-center hover:bg-[#6a8349] duration-150 cursor-pointer flex items-center self-start w-full">
                ...
                <a href="../Admin/payment.php" class="py-4 my-2 justify-center bg-[#54683A] duration-150 cursor-pointer flex items-center self-start w-full">
                    <div class="flex items-center w-64">
                        <img class="w-10 select-none pointer-events-none" src="../icons/payment.png" alt="">
                        <p class="ml-4 select-none pointer-events-none">Payment Management</p>
                    </div>    
            ...
            <main class="relative w-full h-full lg:pl-72 overflow-hidden mt-24 pb-28 text-[#527920] tracking-wide">
                <div class="sm:mx-7 mx-3 mt-7 h-full select-none">
                    <div class='select-none flex flex-col h-full text-[#527920]'>
                        <a href="../Admin/payment.php" class="w-14"><img src="../icons/back.svg" class="w-14 active:bg-[#b6b6b6] sm:-ml-1 ml-1 lg:ml-0 cursor-pointer rounded-full duration-150 z-10 hover:bg-[#D9D9D9] p-2" alt=""></a>
                                        ...
                                        while($row=$result->fetch_assoc()){
                                            ...
                                            echo"
                                                <tr>
                                                    ...
                                                    <td name='datePaid' class='px-2 border-white hidden md:block text-xs h-10 border-b-2 text-black bg-[#DADADA] py-1'>$date <br> $time</td>
                                                    
                                                    <td name='datePaid' class='px-2 md:hidden border-white text-xs h-10 border-b-2 text-black bg-[#DADADA] py-1'>$shortDate <br> $time</td>
                                                </tr>";
                                        }
                                    ?>
                                </table>
