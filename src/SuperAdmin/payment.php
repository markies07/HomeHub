                ...
                <div class="mx-7 mt-7 select-none">
                    ...
                    <div class="flex flex-col items-center justify-center">
                        ...
                        <div class="w-full sm:max-w-[40rem] lg:max-w-[65rem] flex justify-end mt-3">
                            <a href="../PhpCodes/records.php"><button class="bg-[#527920] flex hover:bg-[#709243] duration-150 items-center text-white text-sm font-semibold active:bg-[#5a7535] py-1 px-3">View All Records
