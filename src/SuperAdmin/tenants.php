        ...
        <div class="w-full flex relative flex-col h-[100vh]">
            ...
            <main class="relative w-full h-full lg:pl-72 overflow-hidden mt-24 pb-48 text-[#527920] tracking-wide">
                ...
                <div class="absolute bottom-14 right-4">
                    <a href="../PhpCodes/formerTenants.php"><button class="bg-[#527920] flex hover:bg-[#709243] duration-150 items-center text-white text-sm font-semibold active:bg-[#5a7535] py-1 px-3">View Former Tenants</button></a>
                </div>
